...
**** TODO Open genome by chromatin state
- Annotate each peak with a chromatin state from chippeakanno
- Reduce the chipseeker annotations to simple set
...
bed = "~/cards/analysis/atac/peaks/lib113_hg38_peaks.broadPeak"
...
anno=annoPeaks(peaks, annoDataTxDb)
