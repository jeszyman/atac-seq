...
#+end_src
**** INPROCESS [[file:src/mk_singularity.sh][Make singularity container from docker container]]
:LOGBOOK:
...
#+end_src
** TODO [[file:workflow/atac_read_process.smk][ATAC-seq read processing and alignment]]                          :smk:
:PROPERTIES:
...
**** Quality control                           
***** [[file:workflow/qc.smk][QC snakefile]]                   :smk:noexport:  
:PROPERTIES:
...
****** FastQC                                                      :smk_rule:
:LOGBOOK:
- State "WAITING"    from "TODO"       [2022-03-10 Thu 15:18] \\
  get a fastqc fix
:END:
- Snakemake
  #+begin_src snakemake
...
CLOSED: [2022-03-10 Thu 15:22]
:LOGBOOK:
- State "DONE"       from              [2022-03-10 Thu 15:22]
:END:
- Snakemake
  #+begin_src snakemake
rule samstats:
...
#+end_src
****** DONE Library complexity:smk_rule:
CLOSED: [2022-03-10 Thu 15:22]
:LOGBOOK:
- State "DONE"       from              [2022-03-10 Thu 15:22]
:END:
...
**** Open genome
:LOGBOOK:
- State "DONE"       from "TEST"       [2022-03-31 Thu 13:11]
:END:
...
\printbibliography
****** External files
**** INPROCESS ATAC-seq peak calling and chromatin accessibility run 1 for PCAs 
...
#########1#########2#########3#########4#########5#########6#########7#########8
#+end_src
**** WAITING Differential accessibility                            :smk_rule:
:LOGBOOK:
...
** TODO [[file:workflow/int_test.smk][Integration testing]]                                             :smk:
:PROPERTIES:
...
#+end_src
[[file:basecamp/src/smk_dry_run.sh]]
