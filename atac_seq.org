...
- narrowpeak is used as for https://www.nature.com/articles/s41467-021-21534-4
** Setup
*** Bash preamble
#+name: bash_preamble
#+begin_src bash
...
- [[file:test/inputs/libraries.tsv][Sample sheet]]
  | library | path                          | group |
  |---------+-------------------------------+-------|
  | lib001  | test/inputs/atac1_R1.fastq.gz | ctrl  |
  | lib002  | test/inputs/atac2_R1.fastq.gz | exp   |
  | lib003  | test/inputs/atac3_R1.fastq.gz | exp   |
  | lib004  | test/inputs/atac4_R1.fastq.gz | ctrl  |
...
data_dir: "/home/jeszyman/repos/atac-seq/test"
genome_fasta: "test/inptus/chr19.fa"
sample_sheet: "test/inputs/libraries.tsv"
threads: 4
...
rule make_atac_keep_bed:
    ...
    shell:
        ...
        """
#+end_src
*** TODO do this filt at bedfile step Read pairs were also removed if they overlapped known problematic regions from the ENCODE blacklist_bed [[#amemiya2019][amemiya2019]].
...
#+end_src
- Script
  #+begin_src bash :tangle ./scripts/call_macs2_narrow.sh
#!/usr/bin/env bash
#########1#########2#########3#########4#########5#########6#########7#########8
...
- [[file:./scripts/select_window_size.R][Base script]]
  #+begin_src R :noweb yes :tangle ./scripts/select_window_size.R
...
- [[file:./scripts/pass_config_list_test.R][Base script]]
  #+begin_src R :noweb yes :tangle ./scripts/pass_config_list_test.R
#!/usr/bin/env Rscript
#########1#########2#########3#########4#########5#########6#########7#########8
###
###    SCRIPT TITLE   ###
...
- from cite:corces2018
  #+begin_src bash :tangle ./workflow/scripts/run_macs2_narrow_onesummit.sh
#!/usr/bin/env bash
set -o errexit   # abort on nonzero exitstatus
set -o nounset   # abort on unbound variable
set -o pipefail  # don't hide errors within pipes
...
- [[file:workflow/scripts/diff_chrom_accessibility.R][Base script]]
  #+begin_src R :noweb yes :tangle ./scripts/diff_chrom_accessibility.R
...
- [[file:./scripts/samstats.sh][Base script]]
  #+begin_src bash :tangle ./scripts/samstats.sh
#########1#########2#########3#########4#########5#########6#########7#########8
...
- [[file:./scripts/make_counts.R][Base script]]
  #+begin_src R :noweb yes :tangle ./scripts/make_counts.R
#########1#########2#########3#########4#########5#########6#########7#########8
...
- [[file:./scripts/make_full_nuc_deseq2_object.R][Base script]]
  #+begin_src R :noweb yes :tangle ./scripts/make_full_nuc_deseq2_object.R
#########1#########2#########3#########4#########5#########6#########7#########8
...
- [[file:./scripts/make_nuc_deseq2_object.R][Base script]]
  #+begin_src R :noweb yes :tangle ./scripts/make_nuc_deseq2_object.R
#########1#########2#########3#########4#########5#########6#########7#########8
...
#+begin_src R :noweb yes :tangle ./scripts/make_macs2_consensus_peaks.R
#!/usr/bin/env Rscript
#########1#########2#########3#########4#########5#########6#########7#########8
###
...
#+end_src
- Script
  #+begin_src bash :tangle ./scripts/bamPEFragmentSize_wrapper.sh
#!/usr/bin/env bash
set -o errexit   # abort on nonzero exitstatus
set -o nounset   # abort on unbound variable
set -o pipefail  # don't hide errors within pipes
