...
#+end_src
**** TODO Filter and dedup                                         :smk_rule:
- Snakemake
  #+begin_src snakemake
...
#+end_src
** [[file:workflow/peak_call_and_dif.smk][Peak calling and differential accessibility]]                          :smk:
:PROPERTIES:
:header-args:snakemake: :tangle ./workflow/peak_call_and_dif.smk
:END:
*** TODO peak calling, all samples
- Snakemake
  #+begin_src snakemake
...
*** Snakefiles
**** Read processing and alignment
#+begin_src snakemake :tangle ./workflow/int_test_reads.smk
container: config["container"]
...
*** Bash run scripts
#+begin_src bash
basecamp/src/smk_dry_run.sh config/repo_int_test_reads.yaml workflow/int_test_reads.smk

basecamp/src/smk_draw.sh config/repo_int_test_reads.yaml workflow/int_test_reads.smk resources/int_test_reads.pdf

basecamp/src/smk_run.sh config/repo_int_test_reads.yaml workflow/int_test_reads.smk

basecamp/src/smk_forced_run.sh config/repo_int_test_reads.yaml workflow/int_test_reads.smk

basecamp/src/smk_dry_run.sh config/repo_int_test_peaks.yaml workflow/int_test_peaks.smk

basecamp/src/smk_draw.sh config/repo_int_test_peaks.yaml workflow/int_test_peaks.smk resources/int_test_peaks.pdf

basecamp/src/smk_run.sh config/repo_int_test_peaks.yaml workflow/int_test_peaks.smk

basecamp/src/smk_forced_run.sh config/repo_int_test_peaks.yaml workflow/int_test_peaks.smk
