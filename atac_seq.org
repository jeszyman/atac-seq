...
#+end_src
** INPROCESS [[file:workflow/atac_read_process.smk][ATAC-seq read processing and alignment]]                     :smk:
:PROPERTIES:
...
#+end_src
** INPROCESS ATAC-seq QC
:PROPERTIES:
:header-args:snakemake: :tangle no
:END:
**** TODO ATAC-seq QC:smk_rule:
#+begin_src R
duplicated = "test/bam_atac_raw/lib002.bam"
processed = "test/bam_atac_tn5/lib002_tn5.bam"
